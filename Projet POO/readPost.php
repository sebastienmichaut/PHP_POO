...
<div class="container">
  <div class="row">
    <h1 class="fst-italic" style="background-color: rgb(0,212,255); font-weight: bold; margin-top: 20px; width: 58.5%">Lire un article</h1>
...
<div class="container">
  <div class="row">
    <h2 class="mt-5 fst-italic" style="background-color: rgb(0,212,255); font-weight: bold; width: 58.5%">Les commentaires</h2>
      <?php
